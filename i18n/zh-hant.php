  ...
  <body style="background: url('bg.png') no-repeat fixed right bottom; overflow:hidden;">
    ...
    <div class="container">
        ...
        <div id="s3" class="row hof"> <!-- step 3 -->
          ...
          <div class="col-md-7">
            <div class="button" data-toggle="buttons">
              ...
              <label class="btn btn-default btn-block" onclick="$('#i3').show();"><input type="radio" id="s32" name="s3" value="2" />我要釋出從某個媒體作品當中所描寫或描繪的作品</label>
              <label class="btn btn-default btn-block" onclick="$('#i3').show();"><input type="radio" id="s33" name="s3" value="3" />我要釋出媒體作品與從其作品當中所描寫或描繪的作品</label>
            </div>
            <br />
            <p>如果您的作品是從某人的作品以複雜方式進行描繪/描寫或將某人的作品包含其中，那麼該作品就是一件<a href="//commons.wikimedia.org/wiki/Commons:Derivative_works" target="_blank"><b>衍伸創作作品</b></a>，一般必須要提供該作品與其原始作品的著作權持有者釋出許可。</p>
      ...
      <div id="result" class="row hof">
        <br />
        step 5 of 5 [ <a href="#s1" class="smsc">從頭開始</a> | <a href="//commons.wikimedia.org/wiki/Commons:Help_desk?action=edit&section=new&preloadtitle=help+with+Wikimedia+OTRS+release+generator+step+5" target="_blank">說明</a> | <a href="//commons.wikimedia.org/wiki/User_talk:FDMS4?action=edit&section=new&preloadtitle=Wikimedia+OTRS+release+generator+feedback" target="_blank">回饋</a> ]
        <br /><br />
