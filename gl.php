...
M.</a>" style="color:#777;"><?=$relgen?></a></small></h1>
...
target="_blank">help</a> | <a href="//commons.wikimedia.org/wiki/User_talk:FDMS4?action=edit&section=new&preloadtitle=Wikimedia+OTRS+release+generator+feedback" 
...
placeholder="Presidente, representante autorizado, … (requirido)" class="form-control" /></div>
            ...
            <div style="display:none;" id="idk">
              <p class="text-danger">Wikimedia OTRS non pode acceptar unha liberación de vostede – por favor, no canto <a 
...
ficheiro ó correo electrónico</label>
            ...
            <br />
            <p>Por favor, use o <a href="//commons.wikimedia.org/wiki/Special:UploadWizard" target="_blank"><b>Asistente de subas</b></a> para subir o ficheiro a 
...
representado no ficheiro multimedia coma o ficheiro multimedia</label>
            ...
            <br />
            <p>Se o traballo multimedia representa ou inclúe o traballo artístico de outra persoa dunha forma non trivial, é un <a 

href="//commons.wikimedia.org/wiki/Commons:Derivative_works" target="_blank"><b>traballo derivado</b></a> e polo tanto é normalmente é precisa unha liberación separada 

do titular dos dereitos de autor da obra de arte representada.</p>
            <p>Nalgúns países, graza á excepción da <a href="//commons.wikimedia.org/wiki/Commons:Freedom_of_panorama" target="_blank"><b>liberdade de 
            ...
            <div id="s4fg" class="form-group"><div class="input-group">
              ...
              <div class="input-group-btn">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  <li><a onclick="$('#licensei').val('Creative Commons Attribution-ShareAlike 4.0 International'); $('#iawattr').show();">Creative Commons Atribución-

Compartir igual 4.0 Internacional</a></li>
                  <li><a onclick="$('#licensei').val('Creative Commons Attribution 4.0 International'); $('#iawattr').show();">Creative Commons Atribución 4.0 

Internacional</a></li>
                  <li><a onclick="$('#licensei').val('Creative Commons CC0 1.0 Universal'); $('#iawattr').hide();">Creative Commons CC0 1.0 Universal (dominio 
...
súas necesidades, a condición de que manteñan os termos da licenza e calquera outras leis aplicábeis.</p>
            <p>Son consciente que este acordo non está limitado a Wikipedia ou os seus sitios relacionados.</p>
...
acordo coa licenza escollida. As modificacións que outros fagan ao traballo non será solicitado que foi feito polo titular dos dereitos de autor.</p>
...
as súas necesidades, a condición de que manteñan as condicións da licenza e calquera outras leis aplicábeis.";
            $b4 = "Son consciente que este acordo non está limitado a Wikipedia ou os seus bsitios relacionados.";
...
coa licenza escollida. As modificacións que outros fagan ó traballo non será atribuído ó titular dos dereitos de autor.";
