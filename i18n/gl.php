    ...
    <div class="container">
      ...
      <form method="post" action="//tools.wmflabs.org/relgen/i18n/gl.php">
        ...
        <div id="s1" class="row hof"> <!-- step 1 -->
          ...
          <div class="col-md-7">
            <div class="button" data-toggle="buttons">
              <label class="btn btn-default btn-block" onclick="$('#iam').show();$('#irep').hide();$('#idk').hide();"><input type="radio" id="s11" name="s1" value="1" />Son o titular dos dereitos de autor</label>
              <label class="btn btn-default btn-block" onclick="$('#iam').show();$('#irep').show();$('#idk').hide();"><input type="radio" id="s12" name="s1" value="2" />Represento ó titular dos dereitos de autor</label>
              <label class="btn btn-default btn-block" onclick="$('#iam').hide();$('#irep').hide();$('#idk').show();"><input type="radio" id="s13" name="s1" value="" />Non coñezo ó titular dos dereitos de autor</label>
            </div>
            <br />
            <p>O titular dos dereitos de autor dun traballo multimedia é a <b>persoa que o creou</b> (fotógrafo, deseñador, pintor, ...), a non ser que os dereitos de autor foran transferidos explicitamente por unha operación legal ou contrato.</p>
            <br /><br />
          </div>
          <div class="col-md-4">
            <div style="display:none;" id="iam">
              ...
              <div style="display:none;" id="irep">
                ...
                <br />
                a miña autoridade<br /><div id="s1fg3" class="form-group"><input id="authi" type="text" name="auth" value="<?php echo $auth;?>" placeholder="Presidente, representante autorizado, … (requirido)" class="form-control" /></div>
              </div>
              <br /><br />
        ...
        <div id="s2" class="row hof"> <!-- step 2 -->
          <br />
          paso 2 de 5 [ <a href="#s1" class="smsc">volver</a> | <a href="//commons.wikimedia.org/wiki/Commons:Help_desk?action=edit&section=new&preloadtitle=help+with+Wikimedia+OTRS+release+generator+step+2" target="_blank">axuda</a> | <a href="//commons.wikimedia.org/wiki/User_talk:FDMS4?action=edit&section=new&preloadtitle=Wikimedia+OTRS+release+generator+feedback" target="_blank">comentarios</a> ]
          <br /><br />
          <div class="col-md-7">
            <div class="button" data-toggle="buttons">
              <label class="btn btn-default btn-block" onclick="$('#iup').show();$('#iatt').show();"><input type="radio" id="s21" name="s2" value="1" />Eu ou outros xa temos subido o ficheiro a Wikimedia Commons</label>
        ...
        <div id="s3" class="row hof"> <!-- step 3 -->
          ...
          <div class="col-md-7">
            <div class="button" data-toggle="buttons">
              <label class="btn btn-default btn-block" onclick="$('#i3').show();"><input type="radio" id="s31" name="s3" value="1" />Quero liberar o traballo multimedia</label>
              <label class="btn btn-default btn-block" onclick="$('#i3').show();"><input type="radio" id="s32" name="s3" value="2" />Quero liberar o traballo representado no ficheiro multimedia</label>
      ...
      <div id="result" class="row hof">
        ...
        ?>
        <div class="col-md-7">
          <p>Se ten un cliente de correo electrónico instalado, simplemente <b>prema o botón</b> para crear o correo de liberación. De forma alternativa, copie e pegue o texto da caixa verde de abaixo nun correo electrónico para <a href="mailto:permissions-es@wikimedia.org" style="white-space:nowrap;">permissions-es@wikimedia.org</a>.</p>
        ...
        <?php
                ...
                if (($s1 == "2") && (($rep == "") || ($auth == ""))) echo "<p class='text-danger'>Erro: Non se indicou o titular dos dereitos de autor e/ou autoridade.</p>";
